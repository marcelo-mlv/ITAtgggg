...
Considering similar works such as \textcite{li2018postprocessing} and \textcite{morrissey2020velassco}, the \gls{dfs} framework adopted in this work will be \gls{hdfs}, as it provides high-throughput distributed storage, data locality, built-in fault tolerance, and seamless integration with the Hadoop/Spark ecosystem. These characteristics are particularly suitable for post-processing and analysis of large-scale simulation outputs. Compared with other distributed file systems, \gls{hdfs} offers a mature and widely adopted platform for combining scalable storage with distributed data processing, reducing implementation complexity while enabling efficient large-scale analytics.
