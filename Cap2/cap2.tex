In this chapter, we present the necessary background and technical concepts to understand and implement the proposed framework.

% Contextualização Teórica

\section{Distributed Processing}

% Definição de processamento distribuído
% Map Reduce como paradigma de processamento distribuído
% HDFS como sistema de arquivos distribuído
