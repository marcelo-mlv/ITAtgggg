...
% Explicar os prox. passos da apresentação, basicamente:

% Research:
% Analyse MapReduce viability as a processing paradigm for this work’s needs;
% Analyse Hadoop Distributed File System (HDFS);
% Evaluate aggregate values other than Survival Time;

% Implementation:
% Analyse the code already made at the ASA project;
% Implement a Distributed File System;
% Implement MapReduce
% Use docker to simulate a computer cluster locally;
% Deploy the solution in ASA cluster afterwards;
