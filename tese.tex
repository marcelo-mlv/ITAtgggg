...
\author{Marcelo Loiola Lopes}{Veras}
\itaauthoraddress{Rua H8D, Ap. 205}{12.228-462}{São José dos Campos--SP}

% Titulo da Tese/Dissertação
\title{Exploring Distributed Computing Architectures for Aerospace Simulation Environments}

% Orientador
\advisorgender{fem}                    % masc ou fem
\advisor{Prof.~Dr.}{Juliana de Melo Bezerra}{ITA}

% Coorientador (Caso não haja coorientador, colocar ambas as variáveis \coadvisorgender e \coadvisor comentadas, com um % na frente)
\coadvisorgender{masc}									% masc ou fem
\coadvisor{1° Ten. Eng.}{Adrisson Rogério Samersla}{IEAv}
...
% Número CDU - (somente para TG) (crux)
% \cdu{???.??}
...
\chapter{Aerospace Simulation Output Distributed Architecture (AeroSOuDA)}
\input{Cap3/cap3}
