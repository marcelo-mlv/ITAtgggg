...
\begin{itemize}
    \item Create a user interface for defining or selecting aggregate functions before processing;
    \item Implement a \gls{dfs} for simulation outputs;
    \item Build distributed-processing logic to extract metrics and compute aggregate results;
